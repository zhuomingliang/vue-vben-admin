<template>
  <div>
    ...
    <LocalInformationModalModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
<script lang="ts">
  ...
  import { columns, searchFormSchema } from './LocalInformation.data';

  export default defineComponent({
    name: 'LocalInformation',
    components: { BasicTable, LocalInformationModalModal, TableAction },
    setup() {
