  ...
  <BasicModal v-bind="$attrs" @register="registerModal" :title="getTitle" @ok="handleSubmit">
    ...
    >
      <FormItem name="file" label="Excel 文件" :wrapperCol="wrapperCol">
        ...
        <span
          ><a
            href="/muban/AccommodationArrange.xlsx"
...
<script lang="ts">
  ...
  import { postImportAccommodationArrange } from '/@/api/demo/AccommodationArrange';
  ...
  export default defineComponent({
    name: 'ImportAccommodationArrangeModal',
    ...
    setup(_, { emit }) {
      ...
      async function handleSubmit() {
        try {
          ...
          await postImportAccommodationArrange({ file: formData.fileList[0] });
          closeModal();
