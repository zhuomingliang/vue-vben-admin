...
<script lang="ts">
  ...
  import { formSchema } from './EpidemicPreventionInstructions.data';
  import {
    ...
    setup(_, { emit }) {
      ...
      async function handleSubmit() {
        try {
          ...
          if (unref(isUpdate)) {
            await putEpidemicPreventionInstructions(values);
          } else {
            delete values.id;
            await postEpidemicPreventionInstructions(values);
          }
          closeModal();
